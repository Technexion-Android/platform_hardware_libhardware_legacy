...
#define WIFI_DRIVER_MODULE_ARG_BCM               "firmware_path=/lib/firmware/brcm/fw_bcm4330_bg.bin nvram_path=/lib/firmware/brcm/brcmfmac4330-sdio.txt"
...
int wifi_insmod_driver_bcm()
{
    ...
    ret=system("/system/bin/sh /system/bin/eth_updown");
    ALOGI("###################eth0_updown %d",ret);
